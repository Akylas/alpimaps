#transportation{
	...
	[class=motorway][ramp=1]['mapnik::geometry_type'=2][zoom>=13],
	[class=trunk][ramp=1]['mapnik::geometry_type'=2][zoom>=13], 
	[class=primary][ramp=1]['mapnik::geometry_type'=2][zoom>=13],
	...
	[class=track]['mapnik::geometry_type'=2][zoom>=15],
