	...
	::casing {
		...
		[class=minor] {
			[zoom>=13] {
				...
				line-width: linear([view::zoom], (13, @residential-width-z13 - 2 * @residential-casing-width-z13), (13.1, @residential-width-z13), (14, @residential-width-z14), (15, @residential-width-z15), (16, @residential-width-z16), (17, @residential-width-z17), (18, @residential-width-z18), (19, @residential-width-z19));
				[brunnel=tunnel] {
					line-dasharray: 4,2;
				}
				[brunnel=bridge] {
		...
		[class=path][zoom>=12] {
			[subclass=steps] {
				[brunnel=bridge][zoom>=14]  {
					...
					line-color: @bridge-casing;
					line-join: round;
					line-width: linear([view::zoom], (13, @steps-width-z13 + 2 * (@paths-background-width + @paths-bridge-casing-width)), (15, @steps-width-z15 + 2 * (@paths-background-width + @paths-bridge-casing-width)), (17, @steps-width-z17 + 2 * (@paths-background-width + @paths-bridge-casing-width)));
				}
				[brunnel=tunnel][zoom>=13] {

					line-width: linear([view::zoom], (13, @steps-width-z13 + 2 * (@paths-background-width + @paths-tunnel-casing-width)), (15, @steps-width-z15 + 2 * (@paths-background-width + @paths-tunnel-casing-width)), (17, @steps-width-z17 + 2 * (@paths-background-width + @paths-tunnel-casing-width)));
		...
		[class=track][zoom>=13] {
			...
			[brunnel=tunnel] {
				line-color: @tunnel-casing;
				line-dasharray: 4,2;
				line-width: linear([view::zoom], (13, @track-width-z13 + 2 * (@paths-background-width + @paths-tunnel-casing-width)), (15, @track-width-z15 + 2 * (@paths-background-width + @paths-tunnel-casing-width)));
				// [tracktype=grade1],
				// [tracktype=grade2] {
				...
				// [zoom>=15]{
				[tracktype=grade1] {
					line-width: linear([view::zoom], (13, @track-grade1-width-z13), (15, @track-grade1-width-z15 + 2 * (@paths-background-width + @paths-tunnel-casing-width)));
				}
				[tracktype=grade2] {
					line-width: linear([view::zoom], (13, @track-grade2-width-z13), (15, @track-grade2-width-z15 + 2 * (@paths-background-width + @paths-tunnel-casing-width)));
				}
				// }
			}
		}
		...
		[class=path]{
			...
			[subclass=steps] {
				[zoom>=14] {
					...
					line-width: linear([view::zoom], (13,	@steps-width-z13), (17, @steps-width-z15), (19, @steps-width-z17));
				}
			}
		...
		[class=rail][zoom>=8] {
			...
			[zoom>=13] {
				// [brunnel=bridge] {
					...
					[subclass=rail] {
						dark/line-width: linear([view::zoom], (12,	1.5), (13, 2), (16, 2), (20, 5));
						dark/line-color: #707070;
						// dark/line-width: 1.5;
						// light/line-width: 0.75;
						light/line-width: linear([view::zoom], (12,	0.75), (13, 1), (16, 1), (20, 2));
