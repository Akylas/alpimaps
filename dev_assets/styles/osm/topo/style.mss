...
@motorway-low-zoom: #FBB764;
@trunk-low-zoom: #FFEEAA;
@primary-low-zoom: #f3c380;
@secondary-low-zoom: #e8eda0;

@motorway-fill: #FFCC88;
@trunk-fill: #FFEEAA;
@primary-fill: #FFEEAA;
@secondary-fill: #FFEEAA;
...
@residential-casing-width-z18:    0.8;
