...
export const data: { [k: string]: DataProvider } = {
    ...
    IGN: {
        ...
        url: `http://wxs.ign.fr/${gVars.IGN_TOKEN}/geoportail/wmts?LAYER={variant}&EXCEPTIONS=text/xml&FORMAT={format}&SERVICE=WMTS&VERSION=1.0.0&REQUEST=GetTile&STYLE={style}&TILEMATRIXSET=PM&TILEMATRIX={z}&TILEROW={y}&TILECOL={x}`,
        cacheable: true,
        downloadable: true,
        urlOptions: {
