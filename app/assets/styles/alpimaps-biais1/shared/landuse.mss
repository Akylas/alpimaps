...
#landuse {
	...
	[class=residential][zoom<=16]{
		polygon-fill: linear([view::zoom], (9, fadeout(@urbanareas, 0.2)), (12, fadeout(@urbanareas,0.5)));
	}
	[class=track],
	[class=pitch],
	[class=cemetery],
...
#building [zoom>=15]['nuti::buildings'>0]{
	...
	::shadow['nuti::buildings'=1][zoom>=18]{
	  ...
	  [zoom>=17] { polygon-geometry-transform: translate(0,1); }
	  [zoom>=18] { polygon-geometry-transform: translate(0,2); }
	  [zoom>=19] { polygon-geometry-transform: translate(0,3); }
	  [zoom>=20] { polygon-geometry-transform: translate(0,5); } 
		...
		['nuti::buildings'>1][zoom<18]{
			...
			polygon-opacity: linear([view::zoom], (15, 0.0), (15.2, 0.8), (15.5, 1.0));
			}
			
		}
		::case[zoom>=17]{
			line-cap: butt;
			line-width: linear([view::zoom], (17, 0.0), (18, 0.6));
			line-color: #aaa;
		}
