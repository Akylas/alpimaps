...
#roads {
  ::casing {
    ...
    [kind_detail=service][kind_detail=minor] {
      [zoom >= 14][kind!=minor],
      [zoom >= 16] {
        ...
        [kind_detail=minor] {
          line-width: linear([view::zoom], (16, @minor-width-z16), (17, @minor-width-z17), (18, @minor-width-z18), (19, @minor-width-z19));
        }
    ...
    [kind_detail=path][horse=designated] {
      [is_bridge=true] {
        [zoom >= 14] {
    ...
    [kind_detail=footway],
    [kind_detail=path][bicycle!=designated][horse!=designated] {
      [is_bridge=true] {
        [zoom >= 14] {
    ...
    [kind_detail=path][bicycle=designated] {
      [is_bridge=true] {
        [zoom >= 14] {
    ...
    [subkind_detail=tram],
    [subkind_detail='tram-service'][zoom >= 15] {
      [is_bridge=true] {
        [zoom >= 13] {
          line-width: 4;
          [zoom >= 15] {
    ...
    [kind_detail=rail] {
      [subkind_detail=light_rail],
      [subkind_detail=funicular],
      [subkind_detail=narrow_gauge] {
        [is_bridge=true] {
          [zoom >= 14] {
            line-width: 5.5;
            line-color: @bridge-casing;
      ...
      [subkind_detail=rail],
      [subkind_detail=preserved],
      [subkind_detail=monorail][zoom >= 14] {
        [is_bridge=true] {
          [zoom >= 13] {
            line-width: 6.5;
            line-color: @bridge-casing;
      ...
      [subkind_detail=disused][zoom >= 15],
      [subkind=construction][construction != subway],
      [subkind_detail=miniature][zoom >= 15]{
        [is_bridge=true] {
          [zoom >= 13] {
            line-width: 6;
            line-color: @bridge-casing;
  ...
  ::bridges_and_tunnels_background {
    ...
    [kind_detail=rail]{
      [subkind_detail=rail][zoom >= 13],
      [subkind_detail=preserved][zoom >= 13],
      [subkind_detail=monorail][zoom >= 14] {
        [is_bridge=true] {
          line-width: 5;
          line-color: white;
...
#roads {
  ...
  ::halo {
    ...
    [zoom=10][kind_detail=secondary],
    [zoom=11][kind_detail=secondary] {
      line-color: @halo-color-for-minor-road;
      line-width: 2.7;
      line-opacity: 0.4;
      line-join: round;
    ...
    [zoom=10][kind_detail=tertiary],
    [zoom=11][kind_detail=tertiary],
    [zoom=12][kind_detail=unkindified] {
      line-color: @halo-color-for-minor-road;
      line-width: 2.2;
      line-opacity: 0.3;
      line-join: round;
    ...
    [kind_detail=motorway][ramp!=1][zoom >= 6][zoom < 12],
    [kind_detail=motorway][ramp=1][zoom >= 10][zoom < 12],
    [kind_detail=trunk][ramp!=1][zoom >= 6][zoom < 12],
    [kind_detail=trunk][ramp=1][zoom >= 10][zoom < 12],
    [kind_detail=primary][ramp!=1][zoom >= 8][zoom < 12],
    [kind_detail=primary][ramp=1][zoom >= 10][zoom < 12],
    [kind_detail=secondary][zoom >= 11][zoom < 12] {
  ...
  ::fill {
    ...
    [kind_detail=residential],
    [kind_detail=unkindified] {
      [zoom=12][kind_detail=residential] {
        line-color: @unimportant-road;
    ...
    [kind_detail=service][zoom >= 14],
    [kind_detail=minor][zoom >= 16]{
    ...
    [kind_detail=pedestrian][zoom >= 14] {
    ...
    [kind_detail=rail][zoom >= 8],
    [service=spur][zoom >= 13],
      [service=yard][zoom >= 13],
      [service=siding][zoom >= 13] {
      [zoom < 13] {
        line-color: #787878;
        line-width: 0.5;
        ...
        line-join: round;
        .roads_low_zoom[is_tunnel=true], [is_tunnel=true] {
          line-dasharray: 5,2;
        }
      }
      [zoom >= 12] {
        #roads-fill, [is_bridge=true] {
    ...
    // [subkind_detail='INT-preserved-ssy'] {
    //   [zoom >= 12] {
    //     dark/line-width: 1;
    //     dark/line-color: #aaa;
    //     dark/line-join: round;
...
#roads['mapnik::geometry_type'=3] {
  [kind_detail=living_street][zoom >= 14] {
...
#aeroway['mapnik::geometry_type'=3] {
  [kind_detail=runway][zoom >= 11] {
    polygon-fill: @runway-fill;
  }

  [kind_detail=taxiway][zoom >= 13] {
    polygon-fill: @taxiway-fill;
  }

  [kind_detail=helipad][zoom >= 16] {
    polygon-fill: @helipad-fill;
  }
}

// #junctions {
//   [subkind_detail=motorway_junction] {
//     [zoom >= 11] {
//       text-name: "[ref]";
//       text-size: 10;
...
//   [junction=yes],
//   [subkind_detail=traffic_signals] {
//     [zoom >= 15] {
//       text-name: @name;
//       text-size: 10;
//       text-fill: black;
...
#transportation_name[ref_length>=0][zoom < 13] {
  [kind_detail=motorway][zoom >= 10],
  [kind_detail=trunk][zoom >= 11],
  [kind_detail=primary][zoom >= 11],
  [kind_detail=secondary][zoom >= 12] {
    shield-name: [ref];
...
#transportation_name[ref_length>=0] {
  [kind_detail=motorway],
  [kind_detail=trunk],
  [kind_detail=primary],
  [kind_detail=secondary],
...
#transportation_name {
  [subkind_detail=motorway],
  [subkind_detail=trunk],
  [subkind_detail=primary],
  [subkind_detail=motorway],
  [subkind_detail=trunk],
  [subkind_detail=primary] {
    [zoom >= 13] {
      ...
      [tunnel=no] {
        text-halo-radius: @standard-halo-radius;
        [subkind_detail=motorway] { text-halo-fill: @motorway-fill; }
        [subkind_detail=trunk] { text-halo-fill: @trunk-fill; }
        [subkind_detail=primary] { text-halo-fill: @primary-fill; }
      }
    }
    [zoom >= 14] {
      text-size: 9;
  ...
  [subkind_detail=residential],
  [subkind_detail=unkindified],
  [subkind_detail=road],
  [subkind=construction][construction=null],
  [subkind_detail=residential],
  [subkind_detail=unkindified],
  [subkind_detail=road] {
    [zoom >= 15] {
      ...
      text-face-name: @book-fonts;
      text-repeat-distance: @minor-highway-text-repeat-distance;
      [subkind_detail=unkindified] { text-repeat-distance: @major-highway-text-repeat-distance;}
    }
    [zoom >= 16] {
      text-size: 9;
    }
  ...
  [subkind_detail=raceway],
  [subkind_detail=service],
  [subkind_detail=raceway],
  [subkind_detail=service][zoom >= 17] {
    [zoom >= 16] {
      text-name: @name;
      text-size: 9;
      text-fill: black;
      ...
      text-placement: line;
      text-halo-radius: @standard-halo-radius;
      [subkind_detail=raceway] { text-halo-fill: @raceway-fill; }
      [subkind_detail=service] { text-halo-fill: @service-fill; }
      text-face-name: @book-fonts;
      text-repeat-distance: @major-highway-text-repeat-distance;
    }
    [zoom >= 17] {
  ...
  [subkind_detail=living_street],
  [subkind_detail=pedestrian],
  [subkind_detail=living_street][zoom >= 16],
  [subkind_detail=pedestrian][zoom >= 16] {
    [zoom >= 15] {
      text-name: @name;
      text-size: 8;
      text-fill: black;
      ...
      [subkind_detail=pedestrian] { text-halo-fill: @pedestrian-fill; }
      text-face-name: @book-fonts;
      text-repeat-distance: @minor-highway-text-repeat-distance;
    }
    [zoom >= 16] {
...
#roads[name!=null] {
  [subkind_detail=track],
  [subkind_detail=track][zoom >= 16] {
    [zoom >= 15] {
      text-name: @name;
      text-fill: #222;
      text-size: 8;
  ...
  [subkind_detail=bridleway],
  [subkind_detail=footway],
  [subkind_detail=cycleway],
  [subkind_detail=path],
  [subkind_detail=steps],
  [subkind_detail=bridleway],
  [subkind_detail=footway],
  [subkind_detail=cycleway],
  [subkind_detail=path],
  [subkind_detail=steps] {
    [zoom >= 16] {
      ...
      text-dy: 7;
      text-repeat-distance: @major-highway-text-repeat-distance;
      [subkind_detail=steps] { text-repeat-distance: @minor-highway-text-repeat-distance; }
    }
    [zoom >= 17] {
      text-size: 11;
      text-dy: 9;
...
#roads[oneway!=0] {
  [zoom >= 16] {
    ...
    [subkind_detail=motorway],
    [kind_detail=motorway][ramp=1],
    [subkind_detail=trunk],
    [kind_detail=trunk][ramp=1],
    [subkind_detail=primary],
    [kind_detail=primary][ramp=1],
    [subkind_detail=secondary],
    [kind_detail=secondary][ramp=1],
    [subkind_detail=tertiary],
    [kind_detail=tertiary][ramp=1],
    [subkind_detail=residential],
    [subkind_detail=unkindified],
    [subkind_detail=living_street],
    [subkind_detail=road],
