...
#transportation['mapnik::geometry_type'=2] {
    ...
    // line-color: @trunk_orange_light;
    // }
	[brunnel=bridge][zoom>=13] {
		::case_black {
			line-cap: butt;
			line-color:@bridge_casing;
			line-width: linear([view::zoom], (13, 4.1), (14, 5.2), (15, 5.2), (16, 10.8), (17, 17), (18, 33), (19, 65), (22, 501));
		}
		::case_white {
			line-cap: butt;
			line-color:@bridge_background;
			line-width: linear([view::zoom], (13, 3.1), (14, 4.2), (15, 4.2), (16, 9.8), (17, 16), (18, 32), (19, 64), (22, 500));
		}
	}
	...
	[class=sevice][brunnel=tunnel][zoom>=16]{
		...
		[class=trunk],
		[class=motorway] {
			line-color: @trunk_tunnel_orange;
    ...
    [class=primary][zoom>=8] {
		line-color:linear([view::zoom], (8, @primary_orange), (11, @primary_orange_medium), (15, @primary_orange_light));
