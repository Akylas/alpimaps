...
<template>
    <gesturerootview columns="auto,*" padding={20} rows="auto,auto,auto" width="80%">
        ...
        <mdactivityindicator busy={true} row={1} visibility={progress === null ? 'visible' : 'collapse'} />
        <label col={1} fontSize={16 * $fontScale} padding={10} row={1} {text} textWrap={true} verticalAlignment="middle" />
        <mdprogress colSpan={2} margin="10 10 0 10" maxValue={100} row={2} value={progress} visibility={progress !== null ? 'visible' : 'collapse'} />
