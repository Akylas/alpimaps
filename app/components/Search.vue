<template>
    ...
    <MDCardView @loaded="onLoaded" :borderRadius="searchResultsVisible? 10 : 25" margin="10">
        <GridLayout rows="auto,auto" columns="auto, *, auto, auto">
            <TextField ref="textField" col="0" colSpan="2" padding="5 15 5 15" row="0" hint="Search" placeholder="search" returnKeyType="search" @focus="onFocus" @blur="onBlur" @textChange="onTextChange" width="100%" backgroundColor="white" />
            ...
            <ListView col="0" row="1" height="200" colSpan="4" rowHeight="49" :items="dataItems" backgroundColor="white" :visibility="searchResultsVisible ?'visible':'collapsed'" @itemTap="onItemTap">
                <v-template>
                    <GridLayout paddingLeft="15" paddingRight="5" columns="*,auto,auto" rows="*,auto" height="50">
