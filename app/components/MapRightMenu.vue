<template>
    <GridLayout android:marginTop="24" rows="*,auto" @tap="noop">
        ...
        <StackLayout row="1">
            <MDButton class="buttonthemed" @tap="mapModule('customLayers').addSource()" text="add source" />
            ...
            <GridLayout columns="auto,*,auto">
                ...
                <MDTextField col="2" padding="8" variant="filled" placeholder="biais" :text="zoomBiais" @textChange="onZoomBiaisChanged" width="100" backgroundColor="transparent" floating="false" textAlignment="right" verticalAlignment="center" keyboardType="number" />
            </GridLayout>
        </StackLayout>
