<template>
    <GridLayout width="200" v-show="mShowLocationInfo"  height="70" borderRadius="40" backgroundColor="#77000000" padding="6" columns="auto,*,auto" @swipe="showLocationInfo = false">
