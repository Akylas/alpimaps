...
<gesturerootview rows="auto">
    <canvaslabel {height} padding={16}>
        ...
        <stacklayout horizontalAlignment="left" orientation="horizontal" verticalAlignment="top">
            <IconButton color={listeningForBarometer ? colorPrimary : undefined} text="mdi-gauge" on:tap={switchBarometer} />
            <IconButton text="mdi-airplane" on:tap={getNearestAirportPressure} />
            <IconButton text="mdi-refresh" on:tap={resetReference} />
            <IconButton color={$watchingLocation || $queryingLocation ? colorPrimary : undefined} text="mdi-crosshairs-gps" on:tap={askUserLocation} />
        </stacklayout>
    </canvaslabel>
</gesturerootview>
