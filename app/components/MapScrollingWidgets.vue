    ...
    <GridLayout rows="auto,*,auto" columns="70,*,70" isPassThroughParentEnabled>
        ...
        <StackLayout col="2" row="2" verticalAlignment="bottom" isPassThroughParentEnabled padding="2">
            <transition name="scale">
                <MDButton @tap="startDirections" row="0" rowSpan="2" col="2" class="floating-btn buttonthemed" text="mdi-directions" v-show="selectedItemHasPosition" :isUserInteractionEnabled="userInteractionEnabled"/>
            </transition>
            <GridLayout class="floating-btn" :class="locationButtonClass" @tap="askUserLocation" @longPress="onWatchLocation" :isUserInteractionEnabled="userInteractionEnabled">
