<template>
    <GridLayout :columns="columns" rows="*,auto,auto,auto,*" class="details">
        <Label col="0" rowSpan="5" width="40" margin="0 5 0 0" v-show="!!itemIcon" :text="itemIcon |fonticon" class="maki" fontSize="24" textAlignment="center" verticalAlignment="center" color="white" />
        ...
        <MDActivityIndicator v-show="updating" rowSpan="5" col="4" busy class="activity-indicator" />
    </GridLayout>
</template>
<script lang="ts" src="./BottomSheetInfoView.ts"/>
