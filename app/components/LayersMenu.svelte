...
<gesturerootview {...$$restProps} height={240} on:closedBottomSheet={onCloseBottomSheet}>
    <gridlayout bind:this={gridLayout} backgroundColor={$backgroundColor} columns="*,auto">
        {#if loaded}
            <collectionview
                    ...
                    <swipemenu
                        ...
                        <gridlayout
                            ...
                            <stacklayout verticalAlignment="center">
                                <label color={item.layer.opacity === 0 ? $subtitleColor : $textColor} fontSize={13} fontWeight="bold" lineBreak="end" maxLines={2} text={item.name.toUpperCase()} />
                                <label
                                    color={$subtitleColor}
                                    fontSize={11}
