...
<script lang="ts">
    ...
    function drawOnCanvas(event) {
        ...
        const canvas = event.canvas as Canvas; // simple trick to get typings
        ...
        textPaint.setTextSize(14);
        canvas.drawText(
            ` ${formatValueToUnit(item.temperature, UNITS.Celcius)}°`,
            w2,
            (1 - tempHeight / 100) * h - 70,
            textPaint
        );
