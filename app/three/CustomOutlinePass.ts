    ...
    get fragmentShader() {
        return `
			...
			void main() {
				...
				vec4 resultColor = vec4(mix(sceneColor, outlineColor, outline));
				gl_FragColor = vec4( 1.0 - resultColor.x, 1.0 - resultColor.y, 1.0 - resultColor.z, 1);
    ...
    createOutlinePostProcessMaterial() {
        return new THREE.ShaderMaterial({
            uniforms: {
                ...
                multiplierParameters: { value: new THREE.Vector4(1, 1, 2, 1) },
