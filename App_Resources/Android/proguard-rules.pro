...
-keep,allowoptimization public class top.defaults.colorpicker.ColorPickerPopup.ColorPickerObserver** { public  *; }
...
-keep,allowoptimization public class com.caverock.androidsvg.SVG** { public  *; }
