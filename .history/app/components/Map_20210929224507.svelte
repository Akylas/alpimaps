<script lang="ts">
    ...
    async function onMainMapReady(e) {
     ...
     cartoMap = e.object as CartoMap<LatLonKeys>;
        ...
        // setTimeout(async () => {
            ...
            mapContext.runOnModulesOnMainThread('onMapReady', cartoMap);
        // }, 100);
        } catch (error) {
            console.error(error);
        }
    ...
    function onMainMapMove(e) {
        ...
        mapContext.runOnModulesOnMainThread('onMapMove', e);
        executeOnMainThread(()=>{
    ...
    function onMainMapIdle(e) {
        ...
        mapContext.runOnModulesOnMainThread('onMapIdle', e);
    }
    function onMainMapStable(e) {
        ...
        mapContext.runOnModulesOnMainThread('onMapStable', e);
    }
    ...
    async function selectItem({
        ...
        return new Promise<void>(function (resolve, reject) {
            executeOnMainThread(async function () {
                try {
                    didIgnoreAlreadySelected = false;
